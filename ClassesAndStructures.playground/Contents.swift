 ...
 * Tip:
 */
//let originMethod = class_getInstanceMethod(NSString.self, #selector(self.lowercased))
//let swappedMethod = class_getInstanceMethod(NSString.self, #selector(self.uppercased))
